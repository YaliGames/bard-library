  ...
  <div>
    ...
    <div class="mb-4">
      <div class="relative w-full rounded-lg bg-white shadow-sm overflow-hidden focus-within:ring-2 focus-within:ring-[var(--el-color-primary)]">
        ...
        <span class="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-3 text-gray-400 select-none">
    ...
    <div v-if="hasAnyAdvanced" class="bg-white rounded-lg shadow-sm p-4">
      <div class="flex items-center justify-between mb-4">
        ...
        <button v-if="enableExpand" type="button" @click="ui.expanded = !ui.expanded"
      ...
      <div v-show="!enableExpand || ui.expanded">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div v-if="showReadState && isLoggedIn">
            ...
            <el-select v-model="filters.readState" placeholder="选择阅读状态" clearable style="width:100%">
          ...
          <div v-if="showAuthor">
            ...
            <el-select v-model="filters.authorId" filterable clearable placeholder="选择作者" style="width:100%">
      ...
      <div class="mt-4 flex justify-end gap-2">
        <div class="flex-grow text-center">
          ...
          <el-button type="primary" size="large" class="rounded-full px-16" @click="onSearch">搜索</el-button>
        </div>
      </div>
    </div>
  </div>
...
const hasAnyAdvanced = computed(() => props.showShelves || props.showTags || props.showAuthor || (props.showReadState && isLoggedIn.value) || props.showRating)
